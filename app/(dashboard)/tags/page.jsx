...
export default async function TagsPage() {
    ...
    return (<div className="space-y-6">
      <SectionTitle title="Tags" subtitle="Persistent tag registry for section filtering and search."/>
      <div className="grid gap-4 xl:grid-cols-[1.3fr_320px]">
        <Card className="overflow-hidden">
          {tags.map((tag) => (<div key={tag.id} className="flex items-center justify-between gap-3 border-t border-[var(--border)] px-5 py-4 text-[13px] first:border-t-0">
          ...
          <Card className="p-5">
            <div className="space-y-4">
              ...
              <label className="block space-y-2">
                ...
                <input name="color" defaultValue="violet" className="sectionhub-input"/>
              </label>
