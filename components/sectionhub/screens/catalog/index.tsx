...
function SmallCardTitle({ title, action }: { title: string; action?: string }) {
  return (
...
function InputRow({ placeholder = "Type here..." }: { placeholder?: string }) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
        <SectionTitle
          title="Sections"
          subtitle="Manage premium Shopify Liquid sections, versions, previews, pricing, and publishing states."
        />
      ...
      <Card className="p-4">
        <div className="grid gap-3 xl:grid-cols-[1.8fr_repeat(5,1fr)_auto]">
          <input
            ...
            placeholder="Search sections, slugs, or authors"
          />
                  ...
                  <td className="px-5 py-4">
                    <div className="flex flex-wrap gap-1">
                      {section.tags.map((tag) => (
                        <Badge key={tag} label={tag} tone="violet" />
                      ))}
                    </div>
                  </td>
    ...
    <div className="space-y-6">
      <div className="flex flex-col gap-4 xl:flex-row xl:items-end xl:justify-between">
        ...
        <div className="flex flex-wrap gap-2">
          ...
          {editMode ? (
            <Button variant="secondary">Duplicate section</Button>
          ) : null}
      ...
      <div className="grid gap-4 xl:grid-cols-[1.6fr_0.84fr]">
        <div className="space-y-4">
              ...
              <div className="md:col-span-2">
                <Field label="Full description">
                  <textarea
                    ...
                    defaultValue="Hero Banner Pro is optimized for premium storefront launches, campaign landing pages, and product callout moments with strict spacing, configurable media slots, and merchant-safe controls."
                  />
                </Field>
              </div>
          ...
          <Card className="p-5">
            <SmallCardTitle
              title="Tags"
              action="Suggested: conversion, os2.0, featured"
            />
            <div className="flex flex-wrap gap-2">
              {["conversion", "os2.0", "featured", "hero", "mobile-first"].map(
                (tag) => (
                  <Badge key={tag} label={tag} tone="violet" />
                ),
              )}
          ...
          <Card className="p-5">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Field
                label="Main .liquid upload"
                helper="Upload first, then attach metadata."
              >
          ...
          <Card className="p-5">
            ...
            <div className="grid gap-4">
              <Field label="Installation steps">
                <textarea
                  className="sectionhub-textarea"
                  defaultValue="1. Upload the section file into your Shopify theme.&#10;2. Add the section to the homepage template.&#10;3. Configure media, CTA, and overlay settings."
                />
              </Field>
              <Field label="Merchant instructions">
                <textarea
                  className="sectionhub-textarea"
                  defaultValue="Use the headline field for a concise campaign promise. Recommended CTA length is under 24 characters."
                />
              </Field>
              <Field label="Changelog">
                <textarea
                  className="sectionhub-textarea"
                  defaultValue="v2.4.1 Ã¢â‚¬â€ improved media cropping, fixed button spacing, added app block fallback."
                />
              </Field>
            </div>
          </Card>
          <Card className="p-5">
            <SmallCardTitle
              title="Previews"
              action="Images Ã‚Â· Video Ã‚Â· YouTube Ã‚Â· Live URL"
            />
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="md:col-span-2">
                <Field label="Meta description">
                  <textarea
                    className="sectionhub-textarea"
                    defaultValue="Launch-ready hero section with advanced media layout, precision spacing, and merchant-safe settings for Shopify OS 2.0 themes."
                  />
                </Field>
              </div>
...
export function NewSectionScreen() {
  return (
    <SectionFormScreen
      ...
      subtitle="Sections / Upload New Ã‚Â· Create a new premium catalog item with complete documentation, pricing, previews, and publish controls."
    />
  );
}
export function EditSectionScreen() {
  return (
    <SectionFormScreen
      title="Edit Section"
      subtitle="Sections / Hero Banner Pro Ã‚Â· Published Ã‚Â· Update metadata, versioning, pricing, and visibility without losing audit context."
      editMode
    />
  );
}
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-end justify-between gap-4">
        <SectionTitle
          title="Categories"
          subtitle="Group sections into strong browsing paths and keep the marketplace filter system clean."
        />
        ...
        <Card className="p-5">
          ...
          <div className="space-y-4">
            ...
            <Field label="Slug">
              <input
                className="sectionhub-input font-mono"
                defaultValue="conversion-tools"
              />
            </Field>
            <Field label="Description">
              <textarea
                className="sectionhub-textarea"
                defaultValue="High-performing sections focused on lift, intent capture, and merchandising conversion."
              />
            </Field>
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-end justify-between gap-4">
        <SectionTitle
          title="Bundles"
          subtitle="Curate premium bundle offers, control access rules, and expose savings clearly across the catalog."
        />
          ...
          <Card key={bundle.id} className="p-5">
            <div className="grid gap-4 xl:grid-cols-[24px_1.2fr_1.2fr_0.9fr_0.9fr_0.7fr_0.7fr] xl:items-center">
              ...
              <div>
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  {bundle.sections.map((section) => (
                    <Badge key={section} label={section} tone="violet" />
                  ))}
                </div>
              </div>
              <div>
              ...
              <div className="flex items-center justify-between gap-3">
                <Badge
                  label={bundle.status}
                  tone={bundle.status === "Active" ? "success" : "warning"}
                />
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-end justify-between gap-4">
        <SectionTitle
          title="Tags"
          subtitle="Flexible labels for filters, search, merchandising logic, and faster catalog segmentation."
        />
        ...
        <Card className="overflow-hidden">
          ...
          <div className="space-y-0">
            {tags.map((tag) => (
              <div
                key={tag.slug}
                className="flex items-center justify-between border-t border-[var(--border)] px-5 py-4 text-[13px] first:border-t-0"
              >
                <div>
