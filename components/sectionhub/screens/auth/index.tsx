  ...
  return (
    <div className="space-y-5">
      <Field label="Email address">
        <input
          defaultValue="admin@sectionhub.com"
...
export function ForgotPasswordScreen() {
  return (
    <div className="space-y-5">
      ...
      <Field
        label="Email address"
        helper="We’ll send a reset link to your admin inbox."
      >
        <input
          className="sectionhub-input"
          placeholder="admin@sectionhub.com"
        />
      </Field>
      ...
      <Card className="bg-[var(--soft-surface)] p-4">
        ...
        <div className="mt-1 text-[12px] text-[var(--text-secondary)]">
          Reset link sent to a••••@sectionhub.com · resend in 00:42
        </div>
      </Card>
    </div>
  );
    ...
    <div className="space-y-5">
      ...
      <div className="grid gap-3 sm:grid-cols-2">
        ...
        <Card className="p-4">
          ...
          <div className="mt-1 text-[12px] text-[var(--text-secondary)]">
            Reset token expired. Request a new link.
          </div>
        </Card>
      </div>
    </div>
