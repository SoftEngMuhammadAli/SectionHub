...
import { ActivityLogModel, CategoryModel, InstallEventModel, OrderModel, SectionModel, ShopModel, } from "@/lib/models";
...
export async function getDashboardData() {
    ...
    const totalRevenue = paidOrders.reduce((sum, order) => sum + (order.totalAmountCents ?? 0), 0);
